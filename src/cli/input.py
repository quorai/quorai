...
def add_common_args(
    ...
    *,
    ...
    parser.add_argument("--model", type=str, required=False, help="Model name to use (e.g., google/gemini-2.5-flash-lite)")
    return parser
...
def select_model(model_flag: str | None = None) -> tuple[str, str]:
    ...
    # Auto-select when exactly one model is available
