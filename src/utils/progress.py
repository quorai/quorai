...
class AgentProgress:
    ...
    def start(self):
        ...
        if not self.started and self.live is not None:
            self.live.start()
            self.started = True
    ...
    def print(self, *args, **kwargs):
        """Print via the shared console, serialising against the Live refresh lock."""
    ...
    def _refresh_display(self):
        ...
        # Build a fresh table each refresh to avoid row accumulation from
